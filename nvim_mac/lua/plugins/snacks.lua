return {
    ...
    ╚═╝  ╚═══╝╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚═╝     ╚═╝]],
				...
				keys = {
					...
					{ icon = "󰯁", key = "u", desc = "UNRAID_SCRIPTS - Picker", action = function() vim.cmd("cd /Users/zach/unraid/unraid_scripts/") Snacks.picker.files() end },
					{ icon = "", key = "a", desc = "APPDATA - Picker", action = function() vim.cmd("cd /Users/zach/unraid/appdata/") Snacks.picker.files() end },
