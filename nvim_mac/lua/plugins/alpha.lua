return {
  ...
  config = function()
    ...
    dashboard.section.buttons.val = {
      ...
      dashboard.button("h", "   HOME - Picker", ":cd $HOME | lua Snacks.picker.files()<CR>"),
      dashboard.button("u", "   UNRAID_SCRIPTS - Picker", ":cd /Volumes/unraid_scripts | lua Snacks.picker.files()<CR>"),
      dashboard.button("a", "   APPDATA - Picker", ":cd /Volumes/appdata/ | lua Snacks.picker.files()<CR>"),
