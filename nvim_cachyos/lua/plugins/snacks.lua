return {
    ...
    ╚═╝  ╚═══╝╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚═╝     ╚═╝]],
				...
				keys = {
					...
					{ icon = "", key = "U", desc = "Unraid_Scripts - Picker", action = function() vim.cmd("cd /home/zach/unraid/unraid_scripts/") Snacks.picker.files() end },
	...
	keys = {
		...
		},
		{
			"<leader>tc",
			function()
				vim.cmd("cd /opt/custom_scripts/")
				Snacks.picker.files()
			end,
			desc = "[T]elescope Cust",
		},
		{
			"<leader>th",
			function()
				vim.cmd("cd /home/beast/")
				Snacks.picker.files()
			end,
